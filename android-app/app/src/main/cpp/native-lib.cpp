...
Java_com_olympus_launcher_NativeBridge_nativeGetCoreStatus(JNIEnv* env, jobject /* this */) {
#ifdef OLYMPUS_HAS_RPCS3_SOURCE
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_olympus_launcher_NativeBridge_nativeGetBuildInfo(JNIEnv* env, jobject /* this */) {
